// ========================================
// 基礎問題精講III・C SRS - GASコード v1.0
// 作成日時: 2026-04-19T15:00:00+09:00
// ベース: ネクステSRS v1.0 テンプレートから展開
// ========================================
// テンプレート展開仕様書に基づき、定数3箇所のみ変更:
//   SPREADSHEET_ID → デプロイ時に自分のIDに置き換え
//   SHEET_NAME_DATA → K3_SRS_Data
//   SHEET_NAME_META → K3_SRS_Meta
// それ以外のロジックは全て共通（変更不要）
// ========================================
...
var SPREADSHEET_ID = "1D7wEc6pxV25ldqZYZ6YEzWp_ZGQwWMAxnEQRQRWItAs";

// シート名（★基礎問題精講III・C用。他教材と重複不可）
var SHEET_NAME_DATA = "K3_SRS_Data";    // ネクステ: NS_SRS_Data, シス単: SRS_Data_v5
var SHEET_NAME_META = "K3_SRS_Meta";    // ネクステ: NS_SRS_Meta, シス単: SRS_Meta
...
function runAllTests() {
  Logger.log("========================================");
  Logger.log("基礎問題精講III・C SRS GAS テスト実行 - " + new Date().toISOString());
  Logger.log("========================================");
...
function checkDataStatus() {
  ...
  if (sheet) {
    var lastRow = sheet.getLastRow();
    Logger.log("========================================");
    Logger.log("基礎問題精講III・C SRS データ状態チェック");
    Logger.log("========================================");
